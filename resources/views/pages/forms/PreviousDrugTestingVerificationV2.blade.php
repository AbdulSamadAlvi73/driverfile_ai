...
<head>
    <title>PREVIOUS DRUG TESTING VERIFICATION (V2)</title>
    <meta charset="utf-8" />
   ...
   <main class="container-fluid" style="width: 80%;">
        <div class="card mx-sm-2 mx-md-5 my-sm-2 my-md-5 p-3" style="background-color: #FCFCFC"> 
            <div class="text-center p-3" style="background-color: #6DB4F5;">
                <h4 class="text-light p-2">PREVIOUS DRUG TESTING VERIFICATION (V2)</h4>
            </div>
            <hr>
            ...
            <form class="d-flex">
                <div class="row col-12 mt-2">
                    ...
                    <div class="row">
                        <div class="mb-3 col-12 col-lg-12">
                            <label for="city" class="form-label fw-bold">If the driver answers yes to either of these questions, then the motor carrier must NOT use him to perform ANY safety-sensitive functions (as defined in §382.107) until the driver submits documentation of successful completion of the return-to-duty process (as defined in §40.281 through §40.313).</label>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="typeofwork" id="" />
                                <label class="form-check-label" for=""> 
                                    NOT HIRED AND REFERRED TO A SUBSTANCE ABUSE PROFESSIONAL </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="typeofwork" id="" />
                                <label class="form-check-label" for=""> HIRED AND REFERRED TO A SUBSTANCE ABUSE PROFESSIONAL TO BEGIN THE RETURN-TO-DUTY PROCESS </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="typeofwork" id="" />
                                <label class="form-check-label" for=""> HIRED AND DRIVER SUBMITTED DOCUMENTATION OF SUCCESSFUL COMPLETION OF THE RETURN-TO-DUTY PROCESS. (ATTACH PAPERWORK TO THIS FORM). </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="typeofwork" id="" />
                                <label class="form-check-label" for=""> 
                    ...
                    <div class="mb-3 col-12">
                        <label for="completeaddress" class="form-label fw-bold">Please explain other:</label>
                        <textarea name="completeaddress" id="completeaddress" class="form-control" placeholder=""
                            aria-describedby="helpId"></textarea>
                    </div>  
                    <hr>
                    <p class="fw-bold">Designated Employer Representative's Signature:</p>
                        <div class="row">
                            <div class="mb-3 col-12 col-lg-6">
                                <div class="card" style="height: 150px; widht:150px;">
