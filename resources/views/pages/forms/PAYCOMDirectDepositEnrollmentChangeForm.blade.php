...
<head>
    <title>PAYCOM Direct Deposit Enrollment/Change Form</title>
    <meta charset="utf-8" />
   ...
   <main class="container-fluid" style="width: 80%;">
        <div class="card mx-sm-2 mx-md-5 my-sm-2 my-md-5 p-3" style="background-color: #FCFCFC"> 
            <div class="text-center p-3" style="background-color: #6DB4F5;">
                <h4 class="text-light p-2">PAYCOM Direct Deposit Enrollment/Change Form</h4>
            </div>
            <form class="d-flex">
                <div class="row col-12 mt-2">
                    ...
                    <p><b>Employers: </b>Return this form to your local PAYCOM office. For clients using on-line services, please retain a copy of this document for your records.</p>
                    <hr>
                    <div class="row">
                    ...
                    <p>I wish to deposit: <input type="text" name="" id="">% of Net</p>
                    <p>The Specific Dollar Amount of $<input type="text"></p>
                    <p>Remainder of Net Pay <input type="text"> (Place "X" here.)</p>
                    <hr>
                    <div class="row">
                        <div class="mb-3 col-12 col-lg-12">
                            <label for="city" class="form-label fw-bold">Type of account?</label>
                    ...
                    <p>I wish to deposit (check one)</p>
                    ...
                    <hr>
                    <p>I confirm that the above named employee/worker has added or changed a bank account for direct deposit transactions processed be PAYCOM. I reviewed the information provided and it is accurate to the best of my knowledge. My signature below indicates that I have the authority to execute this document on behalf of the client.</p>
