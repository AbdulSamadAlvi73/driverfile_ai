        ...
        <div class="card mx-sm-2 mx-md-5 my-sm-2 my-md-5 p-3" style="background-color: #FCFCFC"> 
            <div class="mt-4">
                ...
                <p><b>Exemptions from withholding.</b> You may claim exemption from withholding for 2018 if both of the
                    following apply.</p>
                <ul>
                    <li>For 2017 you had a right to a refund of all federal income tax withheld because you had no tax
                        liability, and</li>
                    <li>For 2018 you expect a refund of all federal income tax withheld because you expect to have no
                        tax liability.</li>
                </ul>
                <p>If you are exempt, complete <b>only</b> lines 1, 2, 3, 4, and 7 and sign the form to validate it.
                    Your exemption for 2018 expires February 15, 2019. See Pub. 505, Tax Withholding and Estimated Tax,
                    to learn more about whether you qualify for exemption from withholding.</p>
                <P><b>General Instructions.</b> If you aren’t exempt, follow the rest of these instructions to determine
                    the number of withholding allowances you should claim for withholding for 2018 and any additional
                    amount of tax to have withheld. For regular wages, withholding must be based on allowances you
                    claimed and may not be a flat amount or percentage of wages. You can also use the calculator at
                    www.irs.gov/W4App to determine you tax withholding more accurately. Consider using this calculator
                    if you have a working spouse, more than one job, or a large amount of nonwage income outside of your
                    job. After your Form W-4 takes effect, you can also use this calculator to see how the amount of tax
                    you're having withheld compares to your projected total tax for 2018. If you use the calculator, you
                    don't need to complete any of the worksheets for Form W-4.</P>
                <p>Note that if you have too much tax withheld, you will receive a refund when you file your tax return.
                    ...
                    owe a penalty.</p>
                <p>Filers with multiple jobs or working spouses. If you have more than one job at a time, or if you're
                ...
                <b>Personal Allowance Worksheet</b>
                <p>Complete this worksheet on page 3 first to determine the number of withholding allowances to claim.
                </p>
                <p><b>Line C.</b> Head of household please note: Generally, you can claim head of household filing
                    ...
                    status.</p>
                <p><b>Line E.</b> Child tax credit. When you file your tax return, you might be eligible to claim a
                    credit for each of your qualifying children. To qualify, the child must be under age 17 as of
                    December 31 and must be your dependent who lives with your for more than half the year. Toleayn more
                    about this credit, see Pub. 972 Child Tax Credit. To reduce the tax withheld from your pay by taking
                    this credit into account, follow the instrctions on line E of the worksheet. On the worksheet you
                    will be asked about your total income. For this purpose, total income , including income earned by a
                    spouse, during the year.</p>
                <p><b>Line F.</b> Credit for other dependents. When you file your tax return, you might be eligible to
                    clain a credit for each of your dependents that don't qualify for the child tax credit,such as any
                    dependent children age 17 and older. To learn more about this credit, see Pub. 505. To reduce the
                    tax withheld from our pay by taking this credit into account, follow the instructions on line F of
                    the worksheet. On the worksheet, you will be asked about your total income. For this purpose, total
                    income includes all of your wages and other income., including income earned by a spouse, during the
                    year.</p>
                <p><b>Line G.</b> Other credits. You might be able to reduce the tax withheld from your paycheck if you
                    expect to claim other tax credits, such as the earned income tax credit and tax credits for
                    education and child care expenses. If you do so, your paycheck will be larger but the amount of any
                    refund that you receive when you file your tax return will be smaller. Follow the instructions for
                    worksheet 1-6 in Pub. 505 if you want to reduce your withholding to take the credits into account.
                </p>
                ...
                <div class="row col-12">
                    ...
                    <div class="row">
                        <div class="mb-3 col-lg-12">
                            <label for="city" class="form-label fw-bold">5. Total number of allowances you are claiming
                                (from applicable worksheet below)</label>
                        </div>
                    ...
                    <p>Employees, do not complete box 8, 9, or 10. Your employer will complete these boxes if necessary.
                    </p>
                    <p>New hire reporting. Employers are required by law to report new employees to a designated State
                        ...
                        (including for U.S. territories), go to www.acf.hhs.gov/programs/css/employers.</p>
                    ...
                    <div class="row">
                        <div class="mb-3 col-12 col-lg-6">
                            <label for="state" class="form-label fw-bold">G. Other Credits. If you have other credits,
                                see Worksheet 1-6 of Pub. 505 and enter the amount from that worksheet here.</label>
                            <input type="text" name="state" id="state" class="form-control" placeholder=""
                                aria-describedby="helpId" />
                        </div>
                    </div>
                    ...
                    <p> From W-4 Department of the Treasury Internal Revenue Service</p>
                    ...
                    <div class="row">
                        <div class="mb-3 col-lg-12">
                            <label for="city" class="form-label fw-bold">4. Enter an estimate of your 2018 adjustments
                                to income and any additional standard deduction for age and blindness (see Pub.
                                505)</label>
                        </div>
                        <div class="mb-3 col-lg-6">
                            <input type="text" name="city" id="city" class="form-control" placeholder=""
