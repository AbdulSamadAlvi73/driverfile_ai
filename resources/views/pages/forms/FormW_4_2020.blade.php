   ...
   <main class="container-fluid" style="width: 80%;">
        <div class="card mx-sm-2 mx-md-5 my-sm-2 my-md-5 p-3" style="background-color: #FCFCFC"> 
            <div class="mt-4">
                ...
                <p class="text-center fw-bold">Form W-4 (2020)</p>
            ...
            <form class="d-flex">
                <div class="row col-12">
                    <div class="mb-3 col-lg-6 col-12">
                        <label for="firstname" class="form-label fw-bold">First Name and Middle Initial</label>
                    ...
                    <p><b>Exemption from withholding.</b>  You may claim exemption from withholding for 2020 if you meet both of the following conditions: you had no federal income tax liability in 2019 and you expect to have no federal income tax liability in 2020. You had no federal income tax liability in 2019 if (1) your total tax on line 16 on your 2019 Form 1040 or 1040-SR is zero (or less than the sum of lines 18a, 18b, and 18c), or (2) you were not required to file a return because your income was below the filing threshold for your correct filing status. If you claim exemption, you will have no income tax withheld from your paycheck and may owe taxes and penalties when you file your 2020 tax return. To claim exemption from withholding, certify that you meet both of the conditions above by writing "Exempt" on Form W-4 in the space below Step 4(c). Then, complete Steps 1a, 1b, and 5. Do not complete any other steps. You will need to submit a new Form W-4 by February 16, 2021.</p>
                    ...
                    <p><b>Step 4(b).</b> Enter in this step the amount from the Deductions Worksheet, line 5, if you expect to claim deductions other than the basic standard deduction on your 2020 tax return and want to reduce your withholding to account for these deductions. This includes both itemized deductions and other deductions such as for student loan interest and IRAs</p>
