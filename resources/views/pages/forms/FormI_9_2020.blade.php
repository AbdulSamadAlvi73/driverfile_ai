...
<body>
   ...
   <main class="container-fluid" style="width: 80%;">
        <div class="card mx-sm-2 mx-md-5 my-sm-2 my-md-5 p-3" style="background-color: #FCFCFC"> 
            ...
            <p><a href="https://secure.i9.talx.com/Popups/Documents/I-9InstructionsNew.pdf" target="_blank">Instructions for Form I-9</a></p>
                ...
                <div class="row col-12">    
                    ...
                    <p>QR Code - Section 1 <br>
                        ...
                        <div class="form-check mx-3">
                            ...
                            <label class="form-check-label" for=""> I have read and agree with the attestation statement above. </label>
                        </div>
