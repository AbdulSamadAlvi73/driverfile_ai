...
<head>
    <title>Paychex Direct Deposit Enrollment/Change Form (2023)</title>
    <meta charset="utf-8" />
                ...
                <div class="row col-12 mt-2">
                    ...
                    <div class="row">
                        <div class="mb-3 col-12 col-lg-12">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="typeofwork" id="" />
                                <label class="form-check-label" for=""> Update existing account </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="typeofwork" id="" />
                                <label class="form-check-label" for="">  Replace existing </label>
                            </div>
                        </div>
                    </div>
                    <div class="mb-3 col-6">
                        <label for="completeaddress" class="form-label fw-bold">Account # being replaced</label>
                    ...
                    <p>Deposit of Pay (select one): <input type="text" name="" id=""> % of Net</p>
                    <p>The Specific Dollar Amount of $<input type="text"></p>
                    <p>Remainder of Net Pay <input type="text"></p>
                    <hr>
                    <div class="row">
                        <div class="mb-3 col-12 col-lg-12">
                            <div class="form-check">
                    ...
                    <p>Remainder of Net Pay <input type="text"></p>
                        <hr>
                        <h4 class="text-center">CONFIRMATION STATEMENT</h4>
                    <p>I authorize my employer/company to deposit my earnings into the bank account(s) specified above, and, if necessary, to electronically debit my account to correct erroneous entries. I certify my account(s) allow these transactions. Furthermore, I certify that the above listed account number accurately reflects my intended receiving account. I agree that direct deposit transactions I authorize comply with all applicable laws. My signature below indicates that I am agreeing that I am either the account holder or have the authority of the account holder to authorize my employer/company make direct deposits into the named account. I understand that this authorization will remain in full force and effect until I notify Company in writing that I wish to revoke my authorization. I understand that the Company requires at least 5 business days prior notice to cancel this authorization.</p>
                    <p class="fw-bold">Employee/Worker Signature</p>
                        <div class="row">
                            <div class="mb-3 col-12 col-lg-6">
                    ...
                    <div class="row">
                        <div class="mb-3 col-12 col-lg-6">
                            <label for="state" class="form-label fw-bold">Employer/Authorized Company Representative Printed Name</label>
                            <input type="text" name="state" id="state" class="form-control" placeholder=""
                                aria-describedby="helpId" />
                        </div>
                    </div>
                    <p class="fw-bold">Employer/Authorized Company Representative Signature</p>
                        <div class="row">
                            <div class="mb-3 col-12 col-lg-6">
                                <div class="card" style="height: 150px; widht:150px;">
