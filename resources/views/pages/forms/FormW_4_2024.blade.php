   ...
   <main class="container-fluid" style="width: 80%;">
        <div class="card mx-sm-2 mx-md-5 my-sm-2 my-md-5 p-3" style="background-color: #FCFCFC"> 
            <div class="mt-4">
                ...
                <p class="text-center fw-bold">Form W-4 (2024)</p>
                ...
                <div class="row col-12">
                    ...
                    <div class="row">
                        <div class="mb-3 col-12 col-lg-12">
                            <label for="state" class="form-label fw-bold">(c)</label>
                    ...
                    <p><b>Complete Steps 2–4 ONLY if they apply to you; otherwise, skip to Step 5.</b> See page 2 for more information on each step, who can claim exemption from withholding, when to use the online estimator at www.irs.gov/W4App.</p>
                    ...
                    <p>Use the estimator at www.irs.gov/W4App for most accurate withholding for this step (and Steps 3–4) if you or your spouse have self-employment income, use this option:; or <br>
                        (b) Use the Multiple Jobs Worksheet on page 3 and enter the result in Step 4(c) below or <br>
                        (c) If there are only two jobs total, you may check this box. Do the same on Form W-4 for the other job. This option is generally more than (b) if pay at the lower paying job is more thatn half of the pay at the higher paying job. Otherwise, (b) is more accurate. </p>
                    ...
                    <p><b>Exemption from withholding.</b>  You may claim exemption from withholding for 2024 if you meet both of the following conditions: you had no federal income tax liability in 2022 and you expect to have no federal income tax liability in 2024. You had no federal income tax liability in 2022 if (1) your total tax on line 16 on your 2022 Form 1040 or 1040-SR is zero (or less than the sum of lines 18a, 18b, and 18c), or (2) you were not required to file a return because your income was below the filing threshold for your correct filing status. If you claim exemption, you will have no income tax withheld from your paycheck and may owe taxes and penalties when you file your 2024 tax return. To claim exemption from withholding, certify that you meet both of the conditions above by writing "Exempt" on Form W-4 in the space below Step 4(c). Then, complete Steps 1a, 1b, and 5. Do not complete any other steps. You will need to submit a new Form W-4 by February 15, 2024.</p>
                    ...
                    <p><b>Step 4(b).</b> Enter in this step the amount from the Deductions Worksheet, line 5, if you expect to claim deductions other than the basic standard deduction on your 2024 tax return and want to reduce your withholding to account for these deductions. This includes both itemized deductions and other deductions such as for student loan interest and IRAs</p>
