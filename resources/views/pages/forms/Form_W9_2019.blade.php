...
<body>
   ...
   <main class="container-fluid" style="width: 80%;">
        <div class="card mx-sm-2 mx-md-5 my-sm-2 my-md-5 p-3" style="background-color: #FCFCFC"> 
            ...
            <p class="text-center">(Rev. October 2018) Department of the Treasury  Internal Revenue Service <br>

                Go to www.irs.gov/FormW9 for instructions and the latest information. <br>
                Give Form to the  requester. Do not send to the IRS.</p>
            <form class="d-flex">
                <div class="row col-12 mt-4">
                    ...
                    <div class="row">
                        <div class="mb-3 col-12 col-lg-12">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="typeofwork" id="" />
                                <label class="form-check-label" for=""> S Corporation </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="typeofwork" id="" />
                    ...
                    <div class="mb-3 col-12">
                        <label for="completeaddress" class="form-label fw-bold">Requester's name and address (optional):</label>
                    ...
                    <p>1. The number shown on this form is my correct taxpayer identification number (or I am waiting for a number to be issued to me); and <br>
                        ...
                        <p><b>Certification instructions.</b> You must cross out item 2 above if you have been notified by the IRS that you are currently subject to backup withholding because you have failed to report all interest and dividends on your tax return. For real estate transactions, item 2 does not apply. For mortgage interest paid, acquisition or abandonment of secured property, cancellation of debt, contributions to an individual retirement arrangement (IRA), and generally, payments other than interest and dividends, you are not required to sign the certification, but you must provide your correct TIN.</p>
                    ...
                    <p>- Form 1099-INT (interest earned or paid) <br>
                        ...
                        <p class="text-right">Form W-9 (Rev. 10-2018)</p>
